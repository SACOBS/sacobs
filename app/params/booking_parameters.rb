class BookingParameters < Struct.new(:params)
  ...
  private
   ...
   def client_attributes
     { client_attributes: [:id, :_destroy, :name, :surname, :high_risk,:cell_no, :home_no, :work_no, :email, :bank_id ,address_attributes: [:id, :street_address1, :street_address2, :city, :postal_code, :_destroy] ] }
   end
