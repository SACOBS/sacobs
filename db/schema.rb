...
ActiveRecord::Schema.define(version: 20160201112044) do
  ...
  add_index "charges", ["description"], name: "index_charges_on_description", unique: true, using: :btree
  ...
  add_index "passenger_types", ["description"], name: "index_passenger_types_on_description", unique: true, using: :btree
