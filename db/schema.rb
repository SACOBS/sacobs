...
ActiveRecord::Schema.define(version: 20_140_922_075_450) do
  ...
  add_index 'addresses', %w(addressable_id addressable_type), name: 'index_addresses_on_addressable_id_and_addressable_type', using: :btree
