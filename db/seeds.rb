...
# EL to CT
el_to_ct = Route.create(start_city: City.find_by(name: 'East London' ),end_city: City.find_by(name: 'Cape Town'), distance: 1038, cost: 0)
...
# PE to EL
pe_to_el = Route.create(end_city: City.find_by(name: 'East London' ), start_city: City.find_by(name: 'Port Elizabeth'), distance: 286, cost: 0)
pe_to_el.connections.build(to_city: City.find_by(name: 'Alexandria' ), from_city: City.find_by(name: 'Port Elizabeth' ), distance: 105 )
pe_to_el.connections.build(to_city: City.find_by(name: 'Port Alfred' ), from_city: City.find_by(name: 'Alexandria' ), distance: 51 )
pe_to_el.connections.build(to_city: City.find_by(name: 'East London' ), from_city: City.find_by(name: 'Port Alfred' ), distance: 132)
pe_to_el.save!
...
el_to_pe.connections.build(from_city: City.find_by(name: 'East London' ), to_city: City.find_by(name: 'Port Alfred' ), distance: 132 )
el_to_pe.connections.build(from_city: City.find_by(name: 'Port Alfred' ), to_city: City.find_by(name: 'Alexandria' ), distance: 51 )
el_to_pe.connections.build(from_city: City.find_by(name: 'Alexandria' ), to_city: City.find_by(name: 'Port Elizabeth' ), distance: 105 )
el_to_pe.save!
